...
in
{
  ...
  nix.package = inputs.determinate.inputs.nix.packages.${pkgs.stdenv.hostPlatform.system}.default;
  home.packages = [
  ...
  home.sessionVariables.NIX_CONFIG_REV = flake.rev or flake.dirtyRev or "null";
  home.sessionVariables.NIX_CONFIG_DIR = config.my.config.directory;
  home.sessionVariables.NIX_CONFIG_LAST_MODIFIED = builtins.toString flake.lastModified or "unknown";
